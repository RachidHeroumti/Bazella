          ...
          <div class="p-2 flex flex-col justify-center md:justify-normal items-center  md:block ">
            ...
            <div v-else class="flex flex-col mb-[25px] space-y-2 font-semibold text-13.6px w-full ">
              ...
              <button
                ...
                "
                @click="buyNow"
                class="flex justify-center w-full p-2 text-white ai-c bg-black click-effect px-20px min-h-[50px] py-[13px] "
              >
                <span class="w-full">{{
                  $settings.sections.product.buy_now.text
                }}</span>
              </button>
            </div>
      ...
      {{ $settings.sections.product.shipping_info.description }}  
          ...
          >
            <div class="flex items-center">
              ...
              <h3 class="p-2 whitespace-nowrap">
      ...
      <div class="p-2 modal_variante_content">
        ...
        <div class="mb-1 w-f row">
          <div v-if="showVarianteModal">
            ...
            <p class="fw-b fs-1">
              {{ variant.price.salePrice }} {{ $store.state.currency.symbol }}
              <small class="fw-500" style="color: #2aa900">{{
                variant.quantity.instock >= quantity
                  ? "Disponible"
                  : "OutOfstock"
              }}</small>
            </p>
...
export default {
      ...
      socialMedia: [
        {
          ...
          image: "https://www.svgrepo.com/show/510129/pintrest.svg",
        },
        {
          name: "facebook",
          image: "https://www.svgrepo.com/show/506477/facebook.svg",
          url: "https://www.facebook.com/sharer.php?u={url}",
        },
        {
          name: "twitter",
          url: "https://twitter.com/intent/tweet?url={url}&text={title}",
          image: "https://www.svgrepo.com/show/508977/twitter-3.svg",
        },
    ...
    try {
      ...
      [
        ...
        },
        {
          hid: "productID",
          itemprop: "productID",
          content: this.item && this.item ? this.item._id : "productID",
        },
      ].forEach((meta) => {
  ...
  methods: {
    ...
    buyNow() {
      ...
      if (
        this.$settings.checkout_required_fields.show_variante_reminder &&
        this.item.type == "variable" &&
        !this.showVarianteModal
      ) {
