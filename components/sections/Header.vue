    ...
    <div class="relative    text-primary px-40px bg-white border-b border">
        ...
        <div class=" flex items-center justify-between  py-20px">
            ...
            <div class="flex items-center justify-start  h-full ">
                ...
                <button v-if="$settings.sections.header.icons.search" @click="showSearch=true" aria-label="Search button" class="relative p-2 mx-1  item">
            ...
            <div class="flex items-center justify-center  leading-1.4 text-13.6px tracking-0.2em  ">
                
                <router-link to="/shop" class=" py-7.5px px-15px" >
                    <div class="     font-normal text-black flex justify-center items-center">
                        <span class=" uppercase">Shop</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="25px" viewBox="0 -960 960 960" width="25px" fill="#1c1c1c"><path d="M480-353 240-593l46.67-46.67 193.33 193 193.33-193L720-593 480-353Z"/></svg>   
                    </div>     
                </router-link>
                <router-link to="/season" class=" py-7.5px px-15px" >
                    <div class="  tracking-0.2em font-normal text-black flex justify-center items-center">
                        <span class=" uppercase">season</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="25px" viewBox="0 -960 960 960" width="25px" fill="#1c1c1c"><path d="M480-353 240-593l46.67-46.67 193.33 193 193.33-193L720-593 480-353Z"/></svg>   
                    </div>     
                </router-link>
                <router-link to="/">
                ...
                <router-link to="/journal" class=" py-7.5px px-15px" >
                    <div class="    tracking-0.2em font-normal text-black flex justify-center items-center">
                        <span class=" uppercase">journal</span>
                   </div>     
                </router-link>
                <router-link to="/theme-features" class=" py-7.5px px-15px" >
                    <div class="    tracking-0.2em font-normal text-black flex justify-center items-center">
            ...
            <div class="flex items-center justify-end  icons">
                ...
                <router-link v-if="$settings.sections.header.icons.account" to="/account/orders" title="Account" class=" p-2 mx-1 ">
                    <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#1c1c1c"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z"/></svg> 
                </router-link>
                ...
                <router-link v-if="$settings.sections.header.icons.cart" to="/cart" title="Cart" id="cart-icon" class="relative p-2 mx-1 ">
                    <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill="#1c1c1c"><path d="M240-80q-33 0-56.5-23.5T160-160v-480q0-33 23.5-56.5T240-720h80q0-66 47-113t113-47q66 0 113 47t47 113h80q33 0 56.5 23.5T800-640v480q0 33-23.5 56.5T720-80H240Zm0-80h480v-480h-80v80q0 17-11.5 28.5T600-520q-17 0-28.5-11.5T560-560v-80H400v80q0 17-11.5 28.5T360-520q-17 0-28.5-11.5T320-560v-80h-80v480Zm160-560h160q0-33-23.5-56.5T480-800q-33 0-56.5 23.5T400-720ZM240-160v-480 480Z"/></svg>
