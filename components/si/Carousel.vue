<template>
  <div class="container">
    <div class="m-2 flex justify-between items-center">
      ...
      <div class="flex">
        <button
          class="p-2 bg-gray-100 rounded-md mx-1 hover:bg-gray-200"
          id="prv"
          title="prv"
          @click="move(-1)"
        >
    ...
    <div class="carousel-container" dir="ltr">
      <!-- :style="`width: ${items.length*width}%`" -->
      <div class="flex">
        <!--carousel-->
        <div v-for="(item, i) in items" :key="i" class="p-2" :class="itemClass">
          <!--carousel-item-->
...
export default {
  ...
  methods: {
    move(n) {
      var get = "pop",
        set = "unshift",
        width = document.querySelector(".carousel-item")
